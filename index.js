...
//     });
//   } catch (error) {
//     console.error('Error broadcasting approval update:', error.message, error.stack);
//   }
// }
...
//         maxTimeout: 5000,
//         onRetry: (err, attempt) => {
//           console.log(`Retry attempt ${attempt} for database connection: ${err.message}`);
//         }
//       }
//     );
...
//         process.exit(0);
//       } catch (err) {
//         console.error('Shutdown error:', err.message, err.stack);
//         process.exit(1);
//       }
//     };
...
//     return pool;
//   } catch (err) {
//     console.error('Server initialization failed:', err.message, err.stack);
//     process.exit(1);
//   }
// }
...
//   .then(() => console.log('Server initialization complete'))
//   .catch(err => {
//     console.error('Fatal error during server startup:', err.message, err.stack);
//     process.exit(1);
//   });
...
//       return await poolPromise;
//     } catch (err) {
//       console.error('Failed to get database pool:', err.message, err.stack);
//       throw new Error(`Failed to get database pool: ${err.message}`);
//     }
//   }
// };